...
#define LED_A        22  //LED A on N5 Starter Kit IO Board
#define LED_B        23  //LED B on N5 Starter Kit IO Board
#define LED_C        24 //LED C on N5 Starter Kit IO Board
...
#define BSP_BUTTON_2   3
#define BSP_BUTTON_3   9
#define BSP_BUTTON_4   21
